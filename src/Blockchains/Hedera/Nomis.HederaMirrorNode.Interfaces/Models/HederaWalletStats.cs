...
namespace Nomis.HederaMirrorNode.Interfaces.Models
{
    ...
    /// Hedera wallet stats.
    /// </summary>
    public class HederaWalletStats :
        ...
        IWalletContractStats
    {
        ...
        /// <inheritdoc/>
        [Display(Description = "Wallet balance", GroupName = "hbars")]
        ...
        /// <inheritdoc/>
        [Display(Description = "The movement of funds on the wallet", GroupName = "hbars")]
        public decimal WalletTurnover { get; set; }

        /// <inheritdoc/>
        public IEnumerable<HederaTransactionIntervalData>? TurnoverIntervals { get; set; }

        /// <inheritdoc/>
        [Display(Description = "The balance change value in the last month", GroupName = "hbars")]
        public decimal BalanceChangeInLastMonth { get; set; }

        /// <inheritdoc/>
        [Display(Description = "The balance change value in the last year", GroupName = "hbars")]
        ...
        /// <inheritdoc/>
        [Display(Description = "NFT trading activity", GroupName = "hbars")]
        public decimal NftTrading { get; set; }

        /// <inheritdoc/>
        [Display(Description = "NFT worth on wallet", GroupName = "hbars")]
        ...
        public Dictionary<string, PropertyData> StatsDescriptions => GetType()
            .GetProperties()
            .Where(prop => !IWalletCommonStats<HederaTransactionIntervalData>.ExcludedStatDescriptions.Contains(prop.Name) && Attribute.IsDefined(prop, typeof(DisplayAttribute)))
