...
namespace Nomis.Arbiscan.Interfaces.Models
{
    ...
    /// </summary>
    public class ArbitrumOneWalletStats :
        IWalletCommonStats<ArbitrumOneTransactionIntervalData>,
        IWalletBalanceStats,
        ...
        IWalletContractStats
    {
        ...
        /// <inheritdoc/>
        public IEnumerable<ArbitrumOneTransactionIntervalData>? TurnoverIntervals { get; set; }
        ...
        public Dictionary<string, PropertyData> StatsDescriptions => GetType()
            .GetProperties()
            .Where(prop => !IWalletCommonStats<ArbitrumOneTransactionIntervalData>.ExcludedStatDescriptions.Contains(prop.Name) && Attribute.IsDefined(prop, typeof(DisplayAttribute)))
