...
namespace Nomis.Trustscan.Interfaces.Models
{
    ...
    /// </summary>
    public class TrustEvmWalletStats :
        IWalletCommonStats<TrustEvmTransactionIntervalData>,
        IWalletBalanceStats,
        ...
        IWalletContractStats
    {
        ...
        /// <inheritdoc/>
        public IEnumerable<TrustEvmTransactionIntervalData>? TurnoverIntervals { get; set; }
        ...
        public Dictionary<string, PropertyData> StatsDescriptions => GetType()
            .GetProperties()
            .Where(prop => !IWalletCommonStats<TrustEvmTransactionIntervalData>.ExcludedStatDescriptions.Contains(prop.Name) && Attribute.IsDefined(prop, typeof(DisplayAttribute)))
