...
namespace Nomis.Cubescan.Interfaces.Models
{
    ...
    public class CubeWalletStats :
        IWalletCommonStats<CubeTransactionIntervalData>,
        IWalletBalanceStats,
        ...
        IWalletContractStats
    {
        ...
        /// <inheritdoc/>
        [Display(Description = "Wallet balance", GroupName = "CUBE")]
        ...
        /// <inheritdoc/>
        [Display(Description = "The movement of funds on the wallet", GroupName = "CUBE")]
        public decimal WalletTurnover { get; set; }

        /// <inheritdoc/>
        public IEnumerable<CubeTransactionIntervalData>? TurnoverIntervals { get; set; }

        /// <inheritdoc/>
        [Display(Description = "The balance change value in the last month", GroupName = "CUBE")]
        public decimal BalanceChangeInLastMonth { get; set; }

        /// <inheritdoc/>
        [Display(Description = "The balance change value in the last year", GroupName = "CUBE")]
        ...
        /// <inheritdoc/>
        [Display(Description = "NFT trading activity", GroupName = "CUBE")]
        public decimal NftTrading { get; set; }

        /// <inheritdoc/>
        [Display(Description = "NFT worth on wallet", GroupName = "CUBE")]
        ...
        public Dictionary<string, PropertyData> StatsDescriptions => GetType()
            .GetProperties()
            .Where(prop => !IWalletCommonStats<CubeTransactionIntervalData>.ExcludedStatDescriptions.Contains(prop.Name) && Attribute.IsDefined(prop, typeof(DisplayAttribute)))
