        ...
        IStatCalculator<BobaWalletStats, BobaTransactionIntervalData>
    {
        ...
        public BobaWalletStats GetStats()
        {
            ...
            return new()
            {
                ...
                WalletTurnover = _transactions.Sum(x => decimal.TryParse(x.Value, out decimal value) ? value : 0).ToBoba(),
                ...
                NftTrading = (soldSum - buySum).ToBoba(),
                NftWorth = nftWorth.ToBoba(),
