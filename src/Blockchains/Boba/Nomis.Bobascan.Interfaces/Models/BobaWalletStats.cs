...
namespace Nomis.Bobascan.Interfaces.Models
{
    ...
    /// Boba wallet stats.
    /// </summary>
    public class BobaWalletStats :
        IWalletCommonStats<BobaTransactionIntervalData>,
        IWalletBalanceStats,
        ...
        IWalletContractStats
    {
        ...
        /// <inheritdoc/>
        public IEnumerable<BobaTransactionIntervalData>? TurnoverIntervals { get; set; }
        ...
        public Dictionary<string, PropertyData> StatsDescriptions => GetType()
            .GetProperties()
            .Where(prop => !IWalletCommonStats<BobaTransactionIntervalData>.ExcludedStatDescriptions.Contains(prop.Name) && Attribute.IsDefined(prop, typeof(DisplayAttribute)))
