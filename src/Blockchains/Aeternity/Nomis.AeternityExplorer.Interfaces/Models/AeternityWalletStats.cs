...
namespace Nomis.AeternityExplorer.Interfaces.Models
{
        ...
        IWalletContractStats
    {
        ...
        /// <inheritdoc/>
        [Display(Description = "Wallet balance", GroupName = "AE")]
        ...
        /// <inheritdoc/>
        [Display(Description = "The movement of funds on the wallet", GroupName = "AE")]
        public decimal WalletTurnover { get; set; }

        /// <inheritdoc/>
        public IEnumerable<AeternityTransactionIntervalData>? TurnoverIntervals { get; set; }

        /// <inheritdoc/>
        [Display(Description = "The balance change value in the last month", GroupName = "AE")]
        public decimal BalanceChangeInLastMonth { get; set; }

        /// <inheritdoc/>
        [Display(Description = "The balance change value in the last year", GroupName = "AE")]
        ...
        /// <inheritdoc/>
        [Display(Description = "NFT trading activity", GroupName = "AE")]
        public decimal NftTrading { get; set; }

        /// <inheritdoc/>
        [Display(Description = "NFT worth on wallet", GroupName = "AE")]
        ...
        public Dictionary<string, PropertyData> StatsDescriptions => GetType()
            .GetProperties()
            .Where(prop => !IWalletCommonStats<AeternityTransactionIntervalData>.ExcludedStatDescriptions.Contains(prop.Name) && Attribute.IsDefined(prop, typeof(DisplayAttribute)))
