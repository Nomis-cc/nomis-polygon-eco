...
namespace Nomis.Solscan.Interfaces.Models
{
        ...
        IWalletTokenStats
    {
        ...
        /// <inheritdoc/>
        [Display(Description = "Wallet balance", GroupName = "SOL")]
        ...
        public Dictionary<string, PropertyData> StatsDescriptions => GetType()
            .GetProperties()
            .Where(prop => !IWalletCommonStats<SolanaTransactionIntervalData>.ExcludedStatDescriptions.Contains(prop.Name) && Attribute.IsDefined(prop, typeof(DisplayAttribute)))
