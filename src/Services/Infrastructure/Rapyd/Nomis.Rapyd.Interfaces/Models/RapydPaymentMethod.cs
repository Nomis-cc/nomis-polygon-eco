...
namespace Nomis.Rapyd.Interfaces.Models
{
    ...
    public class RapydPaymentMethod
    {
        ...
        public List<RapydPaymentOption> PaymentOptions { get; set; } = new();
        ...
        public List<RapydAmountRangePerCurrency> AmountRangePerCurrency { get; set; } = new();
        ...
        public List<object> SupportedDigitalWalletProviders { get; set; } = new();
    }
}